                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nombre" class="form-control @error('nombre') is-invalid @enderror" type="text" name="nombre" value="{{ old("nombre") ? old("nombre") : $producto->nombre }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="precio_con_impuesto" min="0" class="form-control @error('precio_con_impuesto') is-invalid @enderror" type="number"
                                name="precio_con_impuesto" value="{{ old("precio_con_impuesto") ? old("precio_con_impuesto") : $producto->precio_con_impuesto }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="procentaje_impuesto" min="0" class="form-control @error('procentaje_impuesto') is-invalid @enderror" type="number"
                                name="procentaje_impuesto" value="{{ old("procentaje_impuesto") ? old("procentaje_impuesto") : $producto->procentaje_impuesto }}">
